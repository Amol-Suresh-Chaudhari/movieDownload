...
export default function QualityPage() {
  ...
  const qualityTitles = {
    ...
    '1080p': '1080P Movies',
    '4k': '2160P 4K Movies',
    '2160p-4k': '2160P 4K Movies'
  }

  const qualityTitle = qualityTitles[params.slug] || `${params.slug.toUpperCase()} Movies`
  ...
  const fetchMovies = async (page = 1, reset = false) => {
    try {
      ...
      queryParams.set('quality', params.slug)
          ...
          <>
            {movies.length > 0 ? (
              ...
              <div className="text-center py-12">
                <p className="text-gray-400 text-lg">No movies found in {qualityTitle.toLowerCase()}.</p>
