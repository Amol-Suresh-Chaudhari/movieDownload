...
export default function LanguagePage() {
  ...
  const languageTitle = languageTitles[params.slug] || `${params.slug.charAt(0).toUpperCase() + params.slug.slice(1)} Movies`
          ...
          <>
            {movies.length > 0 ? (
              ...
              <div className="text-center py-12">
                <p className="text-gray-400 text-lg">No {languageTitle.toLowerCase()} found.</p>
